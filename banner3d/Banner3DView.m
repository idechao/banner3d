...
- (void)start {
    ...
    [self.motionManager startDeviceMotionUpdatesToQueue:[NSOperationQueue currentQueue] withHandler: ^(CMDeviceMotion *motion, NSError *error){
        ...
        [strongSelf update:x gravityY:y gravityZ:z roll:roll pitch:pitch];
    }];
}
...
- (void)update:(double)gravityX gravityY:(double)gravityY gravityZ:(double)gravityZ roll:(double)roll pitch:(double)pitch {
